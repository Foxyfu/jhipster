    ...
    public Optional<Student> partialUpdate(Student student) {
        ...
        return studentRepository
            ...
            .map(existingStudent -> {
                ...
                if (student.getStudyStart() != null) {
                    existingStudent.setStudyStart(student.getStudyStart());
                }
                if (student.getStudyEnd() != null) {
                    existingStudent.setStudyEnd(student.getStudyEnd());
                }
