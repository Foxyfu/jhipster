...
class CompanyResourceIT {
    ...
    public static Company createEntity(EntityManager em) {
        Company company = new Company().companyName(DEFAULT_COMPANY_NAME).location(DEFAULT_LOCATION);
        return company;
    }
    ...
    public static Company createUpdatedEntity(EntityManager em) {
        Company company = new Company().companyName(UPDATED_COMPANY_NAME).location(UPDATED_LOCATION);
        return company;
    }
    ...
    void putExistingCompany() throws Exception {
        ...
        updatedCompany.companyName(UPDATED_COMPANY_NAME).location(UPDATED_LOCATION);
    ...
    void partialUpdateCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCompany.companyName(UPDATED_COMPANY_NAME).location(UPDATED_LOCATION);
